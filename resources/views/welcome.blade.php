                    ...
                    <div
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="text-gray-300 text-sm">2024 • Action • 2h 15m</span>
                            </div>
                            <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                                The Ultimate Action Movie
                            </h3>
                            <p class="text-gray-200 text-lg leading-relaxed">
                                An adrenaline-pumping adventure that will keep you on the edge of your seat. Experience
                                stunning visuals and heart-stopping action sequences in this blockbuster hit.
                            </p>
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center space-x-1">
                                    <span class="text-orange-400 text-2xl">★</span>
                                    <span class="text-white font-semibold">8.5</span>
                                    <span class="text-gray-300">/10</span>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <span class="text-green-400 font-semibold">HD</span>
                        ...
                        <div class="flex justify-center lg:justify-end">
                            <div class="relative">
                                <div
                                    class="w-64 h-96 bg-gray-800 rounded-lg overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
                                    <img src="{{ asset('image/movie.png') }}" alt="Featured Movie Poster"
                                         class="w-full h-full object-cover">
                                </div>
                                <div
                                    class="absolute -top-4 -right-4 w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center shadow-lg">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute bottom-3 right-3 group-hover:opacity-100 transition-opacity duration-300">
                                    <button class="w-7 h-7 bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors duration-200"
                                            onclick="event.stopPropagation(); alert('Added to watchlist!');">
