...
<div class="max-w-3xl mx-auto bg-gray-800 rounded-xl shadow-2xl overflow-hidden hover:shadow-3xl">
    <!-- Movie Poster -->
    <div class="relative">
        <img src="{{asset('storage/'.$movie->picture)}}" alt="Inception Movie Poster" class="w-full h-64 object-cover">
    ...
    <div class="p-4">
        ...
        <p class="text-gray-300 text-sm mb-2 flex items-center">
            ...
            {{ $movie->actor ? $movie->actor : "Leonardo DiCaprio" }}
        </p>
        ...
        <p class="text-gray-300 text-sm mb-2 flex items-center">
            ...
            {{ $movie->actress ? $movie->actress : "Ellen Page" }}
        </p>
        ...
        <p class="text-gray-400 text-sm mb-3 flex items-center">
            ...
            {{ $movie->long_time ? $movie->long_time : "148 min" }}
        </p>
        ...
        <p class="text-gray-300 text-sm mb-4 leading-relaxed">
            {{ $movie->description ? $movie->description : "Dom Cobb is a skilled thief, the absolute best in the dangerous art of extraction, stealing valuable secrets from deep within the subconscious during the dream state, when the mind is at its most vulnerable." }}
        </p>
